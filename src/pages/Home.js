...
const Home = React.forwardRef(
  ({ setNavMenuFocus, scrollTo, getLatestBlogs }, ref) => {
    ...
    const [scrollDownArrowAnimation, setScrollDownArrowAnimation] =
      useState(true)
    ...
    return (
      <>
        <HomeScreen style={fadeInAnimation}>
          ...
          <p>
            A full stack web developer, currently working at Cambridge
            Consultants.
          </p>
          ...
          <ScrollDownButton
            onClick={() => {
              scrollTo(projectRef)
              setScrollDownArrowAnimation(!scrollDownArrowAnimation)
            }}
          >
