...
const Content = (
    <div> 
        <p>
            During the first quarantine in March 2020, I moved back home after my first year of university ended abruptly, picking up chess as my new pandemic hobby. 
        ...
        <p>
            ...
            especially during those excruciating two-week isolation periods in the house.
        </p>
        <br/>
        <p>
            It's kind of a bizarre thought that I would become good friends with these guys a year later who played chess online on Thursdays evenings, 
        ...
        <p>
            ...
            Although matches were played online, I remember feeling nervous before and during each game. Some of these guys
        ...
        <p>
            ...
            We moved to play outside in front of the Student's Union and I met all of the online voices in-person which was humorous at times, a common conversation topic asking what their
            chess or Discord username is. On occasion, it felt like I was playing an old online game but in-person and I already knew who my opponent was by opening or play style.
            I don't think anyone played but Alex played the King's Gambit or Ale with the Tarrasch Defence. 
        </p>
        <br/> 
        <p>
            These in-person chess meetups were fun. 
            ...
            I'll never forget playing bullet against former team captain Alex at like 4 am, stumbling about different pubs and ending up in some accommodation common room.
        ...
        <p>
            Each game could go two hours or longer and I started to feel the effects of psychology in chess. I've had a few games where I had a completely winning position and ended up settling for a draw 
            or pushed too hard and lost because of the pressure which clouded my thoughts. The same scenario on the other side too where I somehow salvaged lost positions.  
        ...
        <p>
            ...
            competitive mindset and handling my emotions. Losses can be tough and it's an unforgiving game but the victories are satisfying and makes the effort worth it. 
            I hope this blog has shown a different perspective on the game and I hope chess will continue to be strong at the University of Sheffield.
        </p>
